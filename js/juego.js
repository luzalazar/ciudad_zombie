...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo ('imagenes/auto_verde_abajo.png', 850, 200, 15, 30, 1),
    new Obstaculo ('imagenes/auto_verde_derecha.png', 400, 480, 30, 15, 1),
    new Obstaculo ('imagenes/auto_verde_derecha.png', 480, 210, 30, 15, 1),
    new Obstaculo ('imagenes/bache.png', 770, 400, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 790, 450, 30, 30, 1),
    new Obstaculo ('imagenes/bache.png', 80, 280, 30, 30, 1),
    new Obstaculo ('imagenes/valla_vertical.png', 820, 85, 30, 30, 1),
  ],
  ...
  enemigos: [
    new ZombieCaminante ('imagenes/zombie1.png', 100, 100, 10, 10, 3, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
    new ZombieCaminante ('imagenes/zombie2.png', 200, 400, 10, 10, 5, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
    new ZombieCaminante ('imagenes/zombie3.png', 460, 350, 10, 10, 1, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
    new ZombieCaminante ('imagenes/zombie4.png', 500, 460, 10, 10, 2, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
    new ZombieCaminante ('imagenes/zombie4.png', 760, 490, 10, 10, 3, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
    
    new ZombieConductor ('imagenes/tren_vertical.png', 644, 23, 30, 90, 3, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 500}, 'v'),
    new ZombieConductor ('imagenes/tren_vertical.png', 673, 474, 30, 90, 1, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 500}, 'v'),
    new ZombieConductor ('imagenes/tren_horizontal.png', 22, 325, 90, 30, 2, { desdeX: 0, hastaX: 860, desdeY: 0, hastaY: 577 }, 'horizontal')
  ]
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    de sus metodos  */
      this.jugador.moverJugador(movX,movY);
  }
};
...
Juego.dibujar = function() {
 ...
 Dibujante.dibujarRectangulo("grey", 760, 530, 125, 10);
 Dibujante.dibujarRectangulo("red",760,530,125,10);
